        ...
        {isPosterOpen && (
          ...
          >
            <motion.a
              ...
              className="relative bg-gradient-to-br from-[#FFF9F0] to-[#F5EFE7] rounded-2xl max-w-2xl w-full shadow-2xl overflow-hidden cursor-pointer hover:shadow-3xl transition-shadow duration-300"
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 z-10 bg-white/90 hover:bg-white text-brand-brown-dark p-2 rounded-full shadow-lg transition-all"
                aria-label="Close"
              >
                <X className="w-5 h-5" />
              </button>
              ...
              <div className="p-8 md:p-12 text-center">
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative w-20 h-20 bg-white rounded-xl p-2 shadow-md">
                    <Image src="/logo.png" alt="Sri Balaji Gold" fill className="object-contain" />
                  </div>
                </div>

                {/* Headline */}
                <h1 className="text-3xl md:text-5xl font-black text-brand-brown-dark leading-tight mb-2" style={{fontFamily: "'Playfair Display', Georgia, serif"}}>
                  OLD TRUST.
                </h1>
                ...
                <h1 className="text-3xl md:text-5xl font-black text-brand-brown-dark leading-tight mb-6" style={{fontFamily: "'Playfair Display', Georgia, serif"}}>
                  SAME TASTE.
                </h1>

                {/* Decorative Line */}
                <div className="flex items-center justify-center gap-3 mb-6">
                  <div className="h-[2px] w-12 bg-gradient-to-r from-transparent to-brand-gold"></div>
                  <Sparkles className="w-5 h-5 text-brand-gold" />
                  <div className="h-[2px] w-12 bg-gradient-to-l from-transparent to-brand-gold"></div>
                </div>

                {/* Description */}
                <p className="text-brand-gold font-bold text-base md:text-lg mb-2">
                  A fresh new look,{' '}
                  <span className="text-[#1E5631]">carrying forward the trusted taste of generations.</span>
                </p>

                {/* Product Image Placeholder */}
                <div className="my-8 bg-white/50 rounded-xl p-6 border-2 border-brand-gold/20">
                  <div className="relative h-48 md:h-64">
                    <Image
                      src="/products/idly rawa.png"
                      alt="New Pack"
                      fill
                      className="object-contain mix-blend-multiply"
                    />
                  </div>
                  <div className="mt-4 inline-block bg-brand-gold text-white px-6 py-2 rounded-full font-bold text-sm shadow-lg">
                ...
                <div className="flex flex-col items-center gap-4">
                  <div className="flex items-center justify-center gap-2 text-[#1E5631] font-medium text-sm">
                    <Wheat className="w-4 h-4" />
                    <span>Since 1980. Trusted by Millions of Families.</span>
                    <Wheat className="w-4 h-4" />
                  </div>
                  
                  {/* Click anywhere hint */}
                  <div className="text-xs text-brand-brown-dark/60 flex items-center gap-1">
                    ...
                    <span>Click poster to follow us on Instagram</span>
                  </div>
                </div>
              </div>
            </motion.a>
